  ...
  return (
    <HeaderWrapper>
      ...
      (<div className='header-forth'>
        ...
        <Link to="/profile/info"><img className="profile" src="https://pluspng.com/img-png/user-png-icon-download-icons-logos-emojis-users-2240.png" style={{width: "40px"}}/></Link>
      </div>)}
    </HeaderWrapper>
  )
};
