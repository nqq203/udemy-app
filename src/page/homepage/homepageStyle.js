      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body2" color="GrayText" marginBottom="20px">
            Get what you left in your cart for less during this limited-time
            “don’t leave learning behind” sale.
          </Typography>
...
export const UserWelcome = ({ username }) => {
  return (
    <UserWelcomeStyle>
      ...
      <Button className="text-button">My learning</Button>
    </UserWelcomeStyle>
  );
};
...
export const CourseItem = (props) => {
  ...
  return (
    <Card
      sx={{ width: 240, height: 400, boxShadow: "none", objectFit: "cover" }}
    >
      <CardMedia
        component="img"
        alt="green iguana"
...
export const SliderContainer = ({ courses }) => {
  ...
  function handleSlideButtons() {
    ...
    slideButtons[0].style.display =
      listCourses.scrollLeft <= 0 ? "none" : "flex";
  ...
  return (
    <SliderContainerStyle>
      <SliderWrapperStyle>
        <div
          className="floating-button position-left"
          id="prev-slide"
          onClick={slideAction}
        >
          <ArrowBackIosNewIcon
        ...
        <div
          className="floating-button position-right"
          id="next-slide"
          onClick={slideAction}
        >
